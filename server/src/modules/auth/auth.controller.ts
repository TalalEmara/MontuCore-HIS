...
export const getAllAthletes = async (req: Request, res: Response): Promise<void> => {
  try{
    const athletes =  await authService.getAllAthletes();
    res.status(200).json({
      athletes
    });
    return;
...
export const getAllClinicians = async (req: Request, res: Response): Promise<void> => {
  try{
    const clinicians =  await authService.getAllClinicians();
    res.status(200).json({
      clinicians
    });
    return;
