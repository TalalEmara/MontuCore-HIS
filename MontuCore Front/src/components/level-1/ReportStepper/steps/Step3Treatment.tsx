  ...
  return (
    <div className={styles.stepContainer}>
      ...
      <TextInput
        ...
        placeholder="E.g., Rest, Ice, Compression, Elevation..."
      ...
      <TextInput
        ...
        value={medication}
        placeholder="E.g., Anti-inflammatory, Pain relief..."
      ...
      <TextInput
        ...
        value={rehabPlan}
        placeholder="E.g., Physiotherapy 3x/week, Range of motion exercises..."
